...
#define Default_SendToUnity_Enter_Room_SERIALIZE OM_NO_OP
...
bool SendToUnity::Door_Bool(0);

const float SendToUnity::getDoor(void) const {
    return Door;
}

void SendToUnity::setDoor(const float p_Door) {
    Door = p_Door;
}

bool SendToUnity::getDoor_Bool(void) {
    return Door_Bool;
}

void SendToUnity::setDoor_Bool(const bool p_Door_Bool) {
...
const SOCKET SendToUnity::getConnectSocketForDoor(void) const {
    return connectSocketForDoor;
}

void SendToUnity::setConnectSocketForDoor(const SOCKET p_connectSocketForDoor) {
...
void SendToUnity::Enter_Room(void) {
    NOTIFY_TRIGGERED_OPERATION(Enter_Room, Enter_Room(), 0, Default_SendToUnity_Enter_Room_SERIALIZE);
    Enter_Room_SendToUnity_Event triggerEvent;
...
IOxfReactive::TakeEventStatus SendToUnity::state_10_processEvent(void) {
    ...
    switch (state_10_active) {
        ...
        case accepttimeevent_25:
        {
            if(IS_EVENT_TYPE_OF(Enter_Room_SendToUnity_Event::Enter_Room_SendToUnity_Event_id) == 1)
                {
...
//#[ ignore
Enter_Room_SendToUnity_Event::Enter_Room_SendToUnity_Event(void) {
    setId(Enter_Room_SendToUnity_Event_id);
}

const IOxfEvent::ID Enter_Room_SendToUnity_Event::Enter_Room_SendToUnity_Event_id(31000);
//#]
